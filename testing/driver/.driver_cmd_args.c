...
int main(int num_args, char* arg_strings[]) 
{
    ...
    char* cmd = "cd /home/shane/Documents/makefs/makefs/testing/hello_tests/hello_files_c; ls -R > files.txt";
    system(cmd);

    /* open file for reading */
    FILE* input_text = fopen ("/home/shane/Documents/makefs/makefs/testing/hello_tests/hello_files_c/files.txt", "r");
    
    /* open file for writing */
    FILE* makefile = fopen("/home/shane/Documents/makefs/makefs/testing/hello_tests/hello_files_c/Makefile", "w");
    ...
    cmd = "cd /home/shane/Documents/makefs/makefs/testing/hello_tests/hello_files_c; make";
    system(cmd);
